...
{/*                                 
        ...
        <Modal
          ...
          <Modal.Body  style={{color:'white'}}>
                     ...
                     <form id="createretro" onSubmit={(evt) => this.createAccount(evt)}>
                    ...
                    <div style={{display:'inline-flex',width:'100%',justifyContent:'flex-start',marginTop:5,marginLeft:'8%'}}>
                          ...
                          <input id='id1' type='Checkbox' Name ='name1' value ="S" onClick={(evt) => this.chbx(evt)} /><br />
                          <input id='id2' type='Checkbox' Name ='name2' value ="S"  onClick={(evt) => this.chbx(evt)} /><br />
                          <input id='id3' type='Checkbox' Name ='name3' value ="S"  onClick={(evt) => this.chbx(evt)} /> <br />
        ...
        >
             ...
             <Modal.Body  style={{color:'white',}}>
                    <form onSubmit={(evt) => this.login(evt)} id="loginbackground" >
