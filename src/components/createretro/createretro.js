...
const submitcreateretro = gql`
    mutation($useruid:String!, $projectname: String!,$sprintnumber:String!,$templatename:String!,$retrocategory1:String!,$retrocategory2:String!,$retrocategory3:String!,$retrocategory4:String!){
        ...
        createretro(useruid:$useruid,projectname:$projectname,sprintnumber:$sprintnumber,
        templatename:$templatename,retrocategory1:$retrocategory1,retrocategory2:$retrocategory2,
        retrocategory3:$retrocategory3,retrocategory4:$retrocategory4){
                    ...
                    <div style={{ width: '100%' }}>
                      ...
                      <Form style={{ width: '100%' }} inline>
                        ...
                        <FormGroup controlId="formInlineEmail">
                          ...
                          <FormControl size={8} style={{ marginLeft: 10 }} type="email" placeholder="Sprint Number" />
                        </FormGroup>
                      ...
                      this.state.templatename === "New Template" ?
                        <div>
                          ...
                          <div style={{ width: '100%', display: 'inline-flex', justifyContent: 'space-evenly' }}>
                            ...
                            <Button disabled={valid} onClick={() => this.newtemplatevalue()}
